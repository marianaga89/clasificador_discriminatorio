...
#que conetgan palabras en espcífico 
...
saveRDS(vieja_loca, "datos/tweets/genero/vieja_loca_geo.RDS")
...
saveRDS(mama_luchona, "datos/tweets/genero/mama_luchona.RDS")
...
saveRDS(como_nina, "datos/tweets/genero/como_nina.RDS")
...
saveRDS(es_de_nina, "datos/tweets/genero/es_de_nina.RDS")
...
saveRDS(como_hombre, "datos/tweets/genero/como_hombre.RDS")
...
saveRDS(tienes_hijos, "datos/tweets/genero/tienes_hijos.RDS")
...
saveRDS(veja_pendeja, "datos/tweets/genero/veja_pendeja.RDS")
...
saveRDS(discriminacion_embarazada, "datos/tweets/genero/discriminacion_embarazada.RDS")
...
saveRDS(discriminacion_mujeres, "datos/tweets/genero/discriminacion_mujeres.RDS")
...
saveRDS(feminazi, "datos/tweets/genero/feminazi.RDS")
...
saveRDS(pinche_lesbiana, "datos/tweets/orientacion/pinche_lesbiana.RDS")
...
saveRDS(lesbiana, "datos/tweets/orientacion/lesbiana.RDS")
...
saveRDS(arroz_popote, "datos/tweets/orientacion/arroz_popote.RDS")
...
saveRDS(punial, "datos/tweets/orientacion/punial.RDS")
...
saveRDS(machorra, "datos/tweets/orientacion/machorra.RDS")
...
saveRDS(pinche_maricon, "datos/tweets/orientacion/pinche_maricon.RDS")
...
saveRDS(pinche_puto, "datos/tweets/orientacion/pinche_puto.RDS")
...
saveRDS(joto, "datos/tweets/orientacion/joto.RDS")
...
saveRDS(lencha, "datos/tweets/orientacion/lencha.RDS")
...
saveRDS(chairo, "datos/tweets/ideologia_politica/chairo.RDS")
...
saveRDS(derechairo, "datos/tweets/ideologia_politica/derechairo.RDS")
...
saveRDS(feminazi, "datos/tweets/ideologia_politica/feminazi.RDS")
...
saveRDS(naco, "datos/tweets/apariencia/naco.RDS")
...
saveRDS(jodido, "datos/tweets/apariencia/jodido.RDS")
...
saveRDS(iztapalacra, "datos/tweets/apariencia/iztapalacra.RDS")
...
saveRDS(chacha, "datos/tweets/apariencia/chacha.RDS")
...
saveRDS(pinche_fresa, "datos/tweets/apariencia/pinche_fresa.RDS")
...
saveRDS(pinche_negro, "datos/tweets/apariencia/pinche_negro.RDS")
...
saveRDS(pinche_gordo, "datos/tweets/apariencia/pinche_gordo.RDS")
...
saveRDS(indio, "datos/tweets/apariencia/pinche_indio.RDS")
...
saveRDS(pinche_pobre, "datos/tweets/apariencia/pinche_pobre.RDS")
...
saveRDS(guerito, "datos/tweets/apariencia/guerito.RDS")
...
saveRDS(pinche_judio, "datos/tweets/religion/pinche_judio_geo.RDS")
...
saveRDS(testiculos_jehova, "datos/tweets/religion/testiculos_jehova.RDS")
...
saveRDS(testigos_jehova, "datos/tweets/religion/testigos_jehova.RDS")
...
saveRDS(religioso_pendejo, "datos/tweets/religion/religioso_pendejo.RDS")
...
saveRDS(pinche_viejo, "datos/tweets/edad/pinche_vieji.RDS")
...
saveRDS(pinche_ninio, "datos/tweets/edad/pinche_ninio.RDS")
...
saveRDS(pareces_nino_chiquito, "datos/tweets/edad/pareces_nino_chiquito.RDS")
...
saveRDS(es_chavo, "datos/tweets/edad/es_chavo.RDS")
...
saveRDS(chavoruco, "datos/tweets/edad/chavoruco.RDS")
...
saveRDS(nini, "datos/tweets/edad/nini.RDS")
...
saveRDS(ciego, "datos/tweets/discapacidad/ciego.RDS")
...
saveRDS(cojo, "datos/tweets/discapacidad/cojo.RDS")
...
saveRDS(discapacitado, "datos/tweets/discapacidad/discapacitado.RDS")
