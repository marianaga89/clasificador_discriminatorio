...
base_discr_comp <-  rbind(read_rds("datos/tweets/base_apariencia.RDS"),
                   read_rds("datos/tweets/base_discapacidad.RDS"),
                   read_rds("datos/tweets/base_edad.RDS"),
                   read_rds("datos/tweets/base_genero.RDS"),
                   read_rds("datos/tweets/base_ideologia.RDS"),
                   read_rds("datos/tweets/base_orientacion.RDS"),
                   read_rds("datos/tweets/base_religion.RDS"),
                   read_rds("datos2/tweets/base_apariencia.RDS"),
                   read_rds("datos2/tweets/base_discapacidad.RDS"),
                   read_rds("datos2/tweets/base_edad.RDS"),
                   read_rds("datos2/tweets/base_genero.RDS"),
                   read_rds("datos2/tweets/base_ideologia.RDS"),
                   read_rds("datos2/tweets/base_orientacion.RDS"),
                   read_rds("datos2/tweets/base_religion.RDS")) %>% 
...
palabras <- read_csv("helpers/catalogo_palabras.csv")
...
#write.csv(base_discr, "datos/tweets_api.csv")
...
#nb class separando entrenamiento y prueba
...
trainNB <- df.train[,3:ncol(df.train)]
testNB <- df.test[,3:ncol(df.test)]
...
classifier_com <- naiveBayes(df[,3:ncol(df.train)], df$class, laplace = 0) 
...
saveRDS(object = classifier_com, "copred_app/base_clasif.rds")

# nubes de palabras -------------------------------------------------------

stop_words <- read_csv("helpers/stopwords_espanol.csv")
